    ...
    function show() {
        if ($this->socialMode == 1) {
            ...
            echo '">';
                ...
                if (($this->tripadvisor) and ( $this->tripadvisor != "")) { ?><a class="social-tripadvisor" itemprop="sameAs" property="sameAs" href="<?= $this->tripadvisor ?>" target="_blank"><? if ($this->iconStyle == "def" || $this->iconStyle == "") { ?> <img src="<?=$this->page->getHomeFolderRelativeHTMLURL()?>ANM22WebBase/website/plugins/com_anm22_wb_editor/img/social/tripadvisor.png" <? } else { ?> <img src="<?= $this->page->getThemeFolderRelativeHTMLURL() ?>img/social/com_tripadvisor.png" <? } ?> style="height:30px; border:0px; float:left; margin-right:10px;" /></a><? }
